...
def main():
    ...
    adv_data = torch.load("adversarial_data.pt")
    train_data = adv_data["train"]
    test_data = adv_data["test"]
    ...
    for epoch in range(start_epoch, epochs):
        ...
        for i, batch in enumerate(train_batches):
            ...
            X = epoch_data[i]["original"]
            adv_input = epoch_data[i]["adversarial"]
            adv_input.requires_grad = True
            y = epoch_data[i]["label"]
